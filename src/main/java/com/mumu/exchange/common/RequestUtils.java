...
public class RequestUtils {
	...
	public static void addForm(Request request, Map<String, String> params, String charset) {
		...
		List<NameValuePair> build = form.build();
		request.bodyForm(build, Charset.forName(charset));
	}
...
//			}
//        }
		String s = JacksonHelper.writeValueAsString(params);
		request.bodyString(s, ContentType.create("application/json", charset));
	}
