...
//		String accessKey4 = "QokwugrmIThjes5bIFm1uO0wE0JCCVwvHqadasd";
//		String secretkey4 = "otdryEMaOSSOtyZwUE044gHX1ow4EQadasd";

//		String accessKey4 = "CI96s16Bkozv3RoAK8v536LpKX6Badasd";
//		String secretkey4 = "c3GfTXumb7cm2uKRR1ZAasdad";

		String accessKey4 = "dbudasdad";
		String secretkey4 = "9f6e260adadsa";

//		AccountInfo accountInfo = TradingServiceFactory.getInstance(Constants.EXCHANGE_NAME.EXCHANGE_BINANCE).accountInfo(accessKey4, secretkey4, "userid");
//		System.out.println(accountInfo);



		Order order = new Order();
		order.setAccountId("22790188");
		order.setSymbol("dogebtc");
		order.setVolume("5");
		...
		Order.Response response = TradingServiceFactory.getInstance(Constants.EXCHANGE_NAME.EXCHANGE_OKEX)
		.orders(order);
